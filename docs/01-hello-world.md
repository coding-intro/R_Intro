...
::: rstudio-cloud
The Posit Cloud (formerly RStudio Cloud) workspace contains the application exercises.
You will obtain an invitation link via e-mail from your trainers.
If you haven't already registered for Posit Cloud, please do so now.
...
::: slides
[Slides](https://coding-intro.github.io/R_Intro/slides/u1-d01-welcome/u1-d01-welcome.html)
:::
:::
...
::: source
[Source](https://github.com/coding-intro/R_Intro/blob/master/docs/application-exercises/ae-01a-un-votes/unvotes.Rmd)
:::
:::
...
::: source
[Exercise template](https://github.com/coding-intro/R_Intro/blob/master/docs/application-exercises/ae-02-bechdel-rmarkdown/bechdel.Rmd)
:::

::: source
[Solution, `.Rmd` file](https://github.com/coding-intro/R_Intro/blob/master/docs/application-exercises/ae-02-bechdel-rmarkdown/bechdel-solution.Rmd)
:::
...
Hickey, W.
(2014, April 1): [The Dollar-And-Cents Case Against Hollywood's Exclusion of Women](https://github.com/coding-intro/R_Intro/blob/master/docs/application-exercises/ae-02-bechdel-rmarkdown/bechdel.Rmd), *FiveThirtyEight.com*
:::
:::
